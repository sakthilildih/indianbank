...
def generate_html_report():
    ...
    # Load data
    predictions = pd.read_csv('outputs/visualizations/fraud_predictions.csv')
    ...
    html_content += """
            ...
            <section>
                ...
                <div class="image-container">
                    <img src="../visualizations/fraud_detection_analysis.png" alt="Fraud Detection Analysis">
                </div>
                
                <h3>Fraud Pattern Analysis</h3>
                <p>Average fraud scores by pattern type, showing which patterns are most indicative of fraud:</p>
                <div class="image-container">
                    <img src="../visualizations/fraud_patterns_analysis.png" alt="Fraud Patterns Analysis">
                </div>
            </section>
...
"""
    ...
    # Write HTML
    with open('outputs/reports/fraud_detection_report.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print("✅ HTML Report generated: outputs/reports/fraud_detection_report.html")
