...
def run_inference(graph_data, account_to_id, num_accounts, df):
    ...
    model.load_state_dict(torch.load('best_fraud_gnn_model.pth', weights_only=True))
...
def create_visualizations(pred_df, df, account_to_id):
    ...
    print("\n✓ Saved visualization: fraud_detection_analysis.png")
    ...
    if 'fraud_pattern' in df.columns:
        ...
        plt.tight_layout()
        plt.savefig('fraud_patterns_analysis.png', dpi=300, bbox_inches='tight')
        print("✓ Saved visualization: fraud_patterns_analysis.png")
